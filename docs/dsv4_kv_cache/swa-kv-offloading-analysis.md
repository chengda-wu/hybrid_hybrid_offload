...
分段 gap 的计算、存储和 Pareto 推导已独立到 [`segmented_checkpoint_gap/segmented-checkpoint-gap-analysis.md`](./segmented_checkpoint_gap/segmented-checkpoint-gap-analysis.md)。
